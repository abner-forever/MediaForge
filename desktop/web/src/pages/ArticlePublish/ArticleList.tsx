...
export default function ArticleList({
  ...
  articleFilter: TabKey;
  editingId: string | null;
  loading: boolean;
  onSelectArticle: (a: ArticleItem) => void;
  onSwitchFilter: (tab: TabKey) => void;
  ...
  return (
    <div
      style={{
        ...
        gap: 0,
        ...(fillHeight ? { flex: 1, overflow: 'hidden' } : {}),
      }}
    >
      ...
      >
        ...
        >
          {/* Filter tabs */}
          <div
            style={{ display: 'flex', gap: 4, flexWrap: 'wrap', marginBottom: 8, flexShrink: 0 }}
          >
            {(Object.keys(TAB_LABELS) as TabKey[]).map((tab) => (
              <FilterTab
                key={tab}
                active={articleFilter === tab}
                onClick={() => onSwitchFilter(tab)}
              >
                {TAB_LABELS[tab]}
              </FilterTab>
            ))}
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 11,
                        color: a.status === 'queued' ? 'var(--accent)' : 'var(--text-muted)',
                        whiteSpace: 'nowrap',
                        flexShrink: 0,
                      }}
                    >
