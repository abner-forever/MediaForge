...
export default function AIToolbar({
  onGenerate, onPolish, onDeAi, onGenerateTitle, onOptimizeLayout,
  genLoading, polishLoading, deAiLoading, titleLoading, layoutLoading,
  content,
}: {
  onGenerate: () => void; onPolish: () => void; onDeAi: () => void;
  onGenerateTitle: () => void; onOptimizeLayout: () => void;
  genLoading: boolean; polishLoading: boolean; deAiLoading: boolean;
  titleLoading: boolean; layoutLoading: boolean;
  content: string;
}) {
  return (
    <div style={{
      ...
      <button onClick={onOptimizeLayout} disabled={layoutLoading || !content} style={{
        display: 'inline-flex', alignItems: 'center', gap: 4,
