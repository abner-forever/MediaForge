...
export default function CoverSection({
  ...
  cover: string;
  coverKeyword: string;
  coverResults: CoverImage[];
  coverLoading: boolean;
  coverSearchLoading: boolean;
  showCoverSearch: boolean;
  ...
  return (
    <div style={{ marginBottom: 0 }}>
      {cover ? (
        ...
        <button
          onClick={onAddCover || onToggleCoverSearch}
          style={{
            display: 'flex',
            alignItems: 'center',
            gap: 6,
      ...
      {showCoverSearch && (
        ...
        >
          <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
            ...
            <button
              className="btn btn-sm"
              onClick={() => onCoverSearch(coverKeyword)}
                      ...
                      <div>
                        ...
                        >
                          {local.map((img, i) => (
                            <div
                              key={`local-${i}`}
                              onClick={() => onSelectCoverImage(img)}
                              style={{
                                position: 'relative',
                                cursor: 'pointer',
                                borderRadius: 6,
                            ...
                            >
                              <img
                                src={onCoverImageUrl(img.path, img.source)}
                                alt=""
