    ...
    <section>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          />
          <span
            style={{ fontSize: 13, fontWeight: 600, color: 'var(--text)', letterSpacing: '0.04em' }}
          >
            最近操作
          </span>
          {opsTotal > 0 && (
            <span
              style={{ fontSize: 12, color: 'var(--text-muted)', fontFeatureSettings: '"tnum"' }}
            >
              共 {opsTotal} 条
            </span>
          )}
        ...
        {ops.length === 0 ? (
          ...
          <div style={{ maxHeight: 256, overflowY: 'auto' }}>
            {ops.map((op, i) => (
              ...
              >
                <span style={{ opacity: 0.4, color: 'var(--text-muted)', display: 'flex' }}>
                  {ACTION_ICONS[op.action] || I.pin(14)}
                </span>
