  ...
  return (
    ...
    >
      <div className="relative bg-bg-secondary">
        ...
        {s.score > 0 && (
          <div
            className={`absolute top-2 left-2 flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[11px] font-bold leading-none ${scoreClass}`}
            title={s.reason}
          >
      ...
      <div className="px-2.5 py-1.5">
        ...
        {s.score > 0 && (
          <div className="text-[9px] text-text-muted/60 truncate mt-0.5" title={s.reason}>
            {s.reason}
          </div>
        )}
        {s.score === 0 && (
