...
export default function UserCenter() {
  ...
  const [checkinStatus, setCheckinStatus] = useState<CheckinStatus>({ can_checkin: false, streak: 0, today_earned: 0 })
  ...
  const handleChangePassword = async (oldPassword: string, newPassword: string) => {
    ...
    try {
      const result = await userApi.changePassword({ old_password: oldPassword, new_password: newPassword })
      if (result.success) {
