...
const ICONS = {
  ...
  credits: (
    <Icon>
      ...
      <path d="M12 6v12" />
      <path d="M15.5 9.5a3.5 3.5 0 0 0-3.5-1c-2.5 0-3.5 1.5-3.5 3s1 2.5 3.5 3c2.5.5 3.5 1.5 3.5 3s-1 3-3.5 3a3.5 3.5 0 0 1-3.5-1" />
    </Icon>
  ),
  settings: (
...
export default function Sidebar() {
  ...
  // 计算活跃的发布任务数
  const activePublishCount = Object.values(publishingTasks).filter(
    (t) => t.status === 'publishing',
  ).length;
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: 999,
                  background: account?.logged_in ? 'var(--status-ok)' : 'var(--status-error)',
                  flexShrink: 0,
                }}
              />
              <div style={{ minWidth: 0 }}>
                ...
                <div
                  style={{
                    fontSize: 11,
                    color: account?.logged_in ? 'var(--status-ok)' : 'var(--status-error)',
                  }}
                >
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: 999,
            background: isDragging ? 'var(--accent)' : 'rgba(255,255,255,0.15)',
