    ...
    <div className="fixed inset-0 z-[9000] flex flex-col items-center justify-center animate-in">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-16 pb-4 pt-12">
        <div className="relative flex items-center justify-center w-full flex-1 min-h-0">
          {showNav && (
            <button onClick={() => lightboxNav(-1)} className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-xl bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all hover:scale-105 backdrop-blur">
          ...
          {showNav && (
            <button onClick={() => lightboxNav(1)} className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-xl bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all hover:scale-105 backdrop-blur">
