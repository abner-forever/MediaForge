...
interface ConfirmDialogProps {
  ...
  checkboxLabel?: string; defaultChecked?: boolean;
  onConfirm: (checkboxChecked: boolean) => void; onCancel: () => void;
}

export default function ConfirmDialog({ open, title, message, confirmText = '确认', cancelText = '取消', danger = false, noLoading = false, checkboxLabel, defaultChecked = false, onConfirm, onCancel }: ConfirmDialogProps) {
